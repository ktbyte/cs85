...
/**
 * Example Application for fetching AQI from Breezometer for a range of locations
 * @author user
 *
 */
public class BreezometerRange 
{
	public static void main(String[] args) throws IOException, UnirestException, JSONException
	{
		...
		br.close();
		final String apiKey = BreezometerPoint.apiKey;
		CSVWriter csv = new CSVWriter(new PrintWriter(new BufferedWriter(new FileWriter("BreezometerRange.csv"))));
